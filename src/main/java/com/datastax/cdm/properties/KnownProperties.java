...
public class KnownProperties {
    ...
    public static final String TARGET_PORT = "spark.cdm.connect.target.yugabyte.port";
    public static final String TARGET_DATABASE = "spark.cdm.connect.target.yugabyte.database";
    ...
    static {
        ...
        defaults.put(TARGET_HOST, "localhost");
        types.put(TARGET_PORT, PropertyType.NUMBER);
        defaults.put(TARGET_PORT, "5433");
        types.put(TARGET_DATABASE, PropertyType.STRING);
        defaults.put(TARGET_DATABASE, "yugabyte");
        types.put(TARGET_USERNAME, PropertyType.STRING);
